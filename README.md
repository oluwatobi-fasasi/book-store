...
This is a book collection app with REACT. This app takes book title and author name as an input, then add it to the book list. You can easily remove any book by clicking the remove button under each book.
...
This project is [MIT](https://github.com/oluwatobi-fasasi/book-store/blob/main/LICENSE) licensed.
